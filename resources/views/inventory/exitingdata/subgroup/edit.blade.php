    ...
    <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            {!! Form::model($subgroup, ['method' => 'PATCH','route' => ['subgroup.update', $subgroup->id]]) !!}
                  ...
                  <div class="row">
                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                      ...
                      <select id="select2Basic" class="select2 form-select form-select-lg" data-allow-clear="true" name="group_id">
                        ...
                        <option value="{{ $group->uuid }}">{{ $group->main_group->code_main_group }}{{ $group->code_group }}-{{ $group->name }}</option>
                        @endforeach
                      </select>
                    </div>
                      <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        <label class="form-label" for="form-repeater-1-2">Code Sub Group</label>
                        {!! Form::text('code_sub_group', null, array('placeholder' => 'code Main Group', 'id' => 'form-repeater-1-1','class' => 'form-control')) !!}
