    ...
    <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            {!! Form::model($comp, ['method' => 'PATCH','route' => ['component.update', $comp->id]]) !!}
                  ...
                  <div class="row">
                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                      ...
                      <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        ...
                        {!! Form::text('code_component', null, array('placeholder' => 'code Component', 'id' => 'form-repeater-1-1','class' => 'form-control')) !!}
                      ...
                      <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        ...
                        {!! Form::text('unit_id', null, array('placeholder' => 'Unit ID', 'id' => 'form-repeater-1-1','class' => 'form-control')) !!}
                        {{-- <input type="text" id="form-repeater-1-5" class="form-control" name="name" /> --}}
                      </div>
                      <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
