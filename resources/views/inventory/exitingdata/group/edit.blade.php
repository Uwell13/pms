              ...
              <div data-repeater-list="group-a">
                <div data-repeater-item>
                  <div class="row">
                    ...
                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                      <label class="form-label" for="form-repeater-1-2">Code Group</label>
                      {!! Form::text('code_group', null, array('placeholder' => 'code Group', 'id' => 'form-repeater-1-1','class' => 'form-control')) !!}
                    ...
                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                      ...
                      {!! Form::text('main_group_id', null, array('placeholder' => 'Main Group', 'id' => 'form-repeater-1-1','class' => 'form-control')) !!}
                      {{-- <input type="text" id="form-repeater-1-5" class="form-control" name="name" /> --}}
                    </div>
                  </div>
                  <hr>
