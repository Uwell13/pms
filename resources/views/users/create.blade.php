                ...
                <div data-repeater-item>
                  <div class="row">
                    ...
                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        ...
                        {!! Form::password('password', array('placeholder' => 'Password','form-repeater-1-5','class' => 'form-control')) !!}
                    ...
                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        ...
                        {!! Form::password('confirm-password', array('placeholder' => 'Confirm Password','form-repeater-1-6','class' => 'form-control')) !!}
